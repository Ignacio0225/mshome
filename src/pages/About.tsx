...
const sections: Section[] = [
    {id: "ro-ro", title: "RO-RO", subtitle: "신차/중고차/특수차량 전용 해상 운송"},
                ...
                <main className={styles.content}>
                        ...
                        <div className={styles.card}>
                            ...
                            <ol className={styles.list}>
                                ...
                                <li>다양한 컨테이너 옵션 제공<br/>
                                    20FT / 40FT 표준 컨테이너, 하이큐브(High Cube), 냉동·냉장 컨테이너, 플랫랙(Flat Rack), 오픈탑(Open Top) 컨테이너 등
                                    화물의 크기, 중량, 특성에 따라 최적의 컨테이너 옵션을 제공합니다.
                                </li>
                                <li>원스톱 통합 물류 서비스<br/>
                                    화물 픽업, 컨테이너 포장, 선적 및 통관, 최종 하역까지 전 과정을 일괄 지원합니다.
                                </li>
                            </ol>
                        </div>
                    </section>
                    ...
                    <section id="air" className={styles.section} aria-labelledby="air-title">
                        ...
                        <div className={styles.card}>
                            ...
                            <ol className={styles.list}>
                                ...
                                <li>다양한 화물 맞춤 솔루션<br/>
                                    일반 화물, 긴급 화물, 고가 화물, 민감 화물, Project Cargo by Air, Door-to-Door 서비스까지
                    ...
                    <section id="agency" className={styles.section} aria-labelledby="agency-title">
                        ...
                        <div className={styles.card}>
                            ...
                            <ul className={styles.list}>
                                <li>국내 주요 항구에서 선박의 입출항과 관련된 절차를 원스톱으로 지원합니다.</li>
                                <li>입항 허가, 하역 계획, 선원 지원, 통관 및 행정 업무까지 전 과정을 전문적으로 관리합니다.</li>
                                <li>하역 관리, 선원 교대, 선용품·연료 공급, 항만세 행정 업무, 유지·보수 네트워크를 지원합니다.</li>
                            </ul>
                        </div>
                    </section>
                        ...
                        <div className={styles.card}>
                            ...
                            <ol className={styles.list}>
                                ...
                                <li>맞춤형 무역 컨설팅 서비스<br/>
                                    통관 규정 분석, 시장 진입 전략, 해외 바이어 협상, 현지 유통망 확보와 사후 관리까지 토털 컨설팅을 제공합니다.
                                </li>
                            </ol>
                        </div>
                    </section>
